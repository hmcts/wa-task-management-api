...
class PriorityDateTimeCalculatorTest {
    ...
    void should_not_supports_when_responses_contains_due_date(boolean configurable) {
        ...
        assertThat(priorityDateTimeCalculator.supports(evaluationResponses, PRIORITY_DATE, configurable)).isFalse();
    }
    ...
    void should_supports_when_responses_only_contains_due_date_time(boolean configurable) {
        ...
        assertThat(priorityDateTimeCalculator.supports(evaluationResponses, PRIORITY_DATE, configurable)).isTrue();
    }
