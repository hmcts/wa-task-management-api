...
class InitiateTaskTest extends CamundaHelpers {
    ...
    void given_initiateTask_with_previous_valid_assignee_should_keep_assignee() {
        ...
        TaskResource mockTaskResource = taskManagementService.initiateTask(taskId, initiateTaskRequest);
        ...
        verify(cftTaskDatabaseService).saveTask(mockTaskResource);
    }
    ...
    void given_initiateTask_with_previous_invalid_assignee_should_reassign() {
        ...
        verify(taskAutoAssignmentService).autoAssignCFTTask(mockTaskResource);
