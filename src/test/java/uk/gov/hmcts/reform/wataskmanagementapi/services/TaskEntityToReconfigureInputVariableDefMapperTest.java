...
class TaskEntityToReconfigureInputVariableDefMapperTest {
    ...
    void should_map_fields_when_mapper_invoked_between_task_entity_and_reconfigure_input_variable_definition() {
        ...
        // Removed 19 attributes from reconfigInputAttributes as they are not required for reconfiguration.
        assertEquals(dbTaskAttributes.size() - 19, reconfigInputAttributes.size());
