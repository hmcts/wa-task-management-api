...
class CFTTaskDatabaseServiceTest extends CamundaHelpers {
    ...
    @Test
    void findByIdAndObtainPessimisticWriteLock_test1() {

        Optional<TaskResource> optionalTaskResource = Optional.of(createTestTask());

        lenient().when(taskResourceRepository.findById(taskId))
    ...
    @Test
    void findByIdOnly_test2() {

        Optional<TaskResource> optionalTaskResource = Optional.of(createTestTask());

        lenient().when(taskResourceRepository.getByTaskId(taskId))
            .thenReturn(optionalTaskResource);
    ...
    void saveTask_test3() {
        ...
        lenient().when(taskResourceRepository.save(taskResource))
    ...
    @Test
    void insertAndLock_test4() throws SQLException {

        taskResource = createTestTask();

        //doNothing().when(taskResourceRepository).insertAndLock(taskId);
