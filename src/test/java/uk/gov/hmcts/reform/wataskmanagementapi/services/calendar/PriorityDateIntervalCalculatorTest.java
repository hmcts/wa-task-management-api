...
import static uk.gov.hmcts.reform.wataskmanagementapi.domain.entities.calendar.PriorityDateIntervalData.PRIORITY_DATE_MUST_BE_WORKING_DAY_NO;
...
class PriorityDateIntervalCalculatorTest {
    ...
    void shouldCalculateWhenDefaultValueProvided() {
        ...
        var priorityDateMustBeWorkingDay = ConfigurationDmnEvaluationResponse.builder()
            ...
            .value(CamundaValue.stringValue(PRIORITY_DATE_MUST_BE_WORKING_DAY_NEXT))
            .build();
    ...
    void shouldCalculateWhenSkipNonWorkingDaysAndMustBeBusinessPrevious() {
        ...
        var priorityDateMustBeWorkingDay = ConfigurationDmnEvaluationResponse.builder()
            .name(CamundaValue.stringValue("priorityDateMustBeWorkingDay"))
            .value(CamundaValue.stringValue(PRIORITY_DATE_MUST_BE_WORKING_DAY_PREVIOUS))
            .build();
    ...
    void shouldCalculateWhenWithoutPriorityDateTime() {
        ...
        var priorityDateMustBeWorkingDay = ConfigurationDmnEvaluationResponse.builder()
            .name(CamundaValue.stringValue("priorityDateMustBeWorkingDay"))
            .value(CamundaValue.stringValue(PRIORITY_DATE_MUST_BE_WORKING_DAY_NO))
            .build();
