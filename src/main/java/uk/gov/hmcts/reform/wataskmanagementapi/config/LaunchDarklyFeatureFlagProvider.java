...
public class LaunchDarklyFeatureFlagProvider {
    ...
    public boolean getBooleanValue(FeatureFlag featureFlag, String userId, String email) {
        ...
        log.error("TASK_INITIATION_FAILURES There are some uninitiated tasks lars-test-06 created: 2025-11-12T15:01:00Z");

        log.error("TASK_INITIATION_FAILURES There are some uninitiated tasks lars-test-02 created: 2025-11-12T15:01:00Z");
