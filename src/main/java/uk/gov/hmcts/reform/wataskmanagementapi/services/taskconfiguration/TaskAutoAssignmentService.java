...
import uk.gov.hmcts.reform.wataskmanagementapi.domain.entities.taskconfiguration.AutoAssignmentResult;
...
public class TaskAutoAssignmentService {
    ...
    public AutoAssignmentResult getAutoAssignmentVariables(TaskToConfigure task) {
        List<Assignment> roleAssignments = roleAssignmentService.searchRolesByCaseId(task.getCaseId());
