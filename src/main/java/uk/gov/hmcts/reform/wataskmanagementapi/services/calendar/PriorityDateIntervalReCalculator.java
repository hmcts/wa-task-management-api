...
@Slf4j
@Component
public class PriorityDateIntervalReCalculator extends DueDateIntervalCalculator {
    ...
    public ConfigurationDmnEvaluationResponse calculateDate(
        List<ConfigurationDmnEvaluationResponse> priorityDateProperties,
        DateType dateType) {
        return calculateDate(dateType, readPriorityDateOriginFields(priorityDateProperties));
    }

    private DateTypeIntervalData readPriorityDateOriginFields(
