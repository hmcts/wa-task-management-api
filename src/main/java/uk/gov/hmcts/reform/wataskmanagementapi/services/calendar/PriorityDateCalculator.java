...
public class PriorityDateCalculator extends DueDateCalculator {
    ...
    public boolean supports(
        ...
        return PRIORITY_DATE == dateType
            && Optional.ofNullable(
                getProperty(dueDateProperties, PRIORITY_DATE.getType(), isReconfigureRequest)).isPresent();
    }
    ...
    public ConfigurationDmnEvaluationResponse calculateDate(
        ...
        var priorityDateResponse = getProperty(priorityDateProperties,
            PRIORITY_DATE.getType(), isReconfigureRequest);
        var priorityDateTimeResponse = getProperty(priorityDateProperties,
            PRIORITY_DATE_TIME, isReconfigureRequest);
