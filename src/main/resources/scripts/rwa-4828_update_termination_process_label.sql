...
select task_id from cft_task_db.cft_task_db.reportable_task where final_state_label is null and termination_process is null and agent_name = 'aeabbbcb-4909-4346-acd5-4e95df4357a3' and outcome = 'Cancelled';

create table IF NOT EXISTS cft_task_db.cft_task_db.manual_cancelled_tasks_ids_backup AS
select task_id from cft_task_db.cft_task_db.reportable_task where final_state_label ='USER_CANCELLED' and termination_process is null  and outcome = 'Cancelled';
...
update cft_task_db.cft_task_db.reportable_task set termination_process_label = 'Manual Cancellation', termination_process = 'EXUI_USER_CANCELLATION' where final_state_label = 'USER_CANCELLED' and termination_process is null  and outcome = 'Cancelled';
