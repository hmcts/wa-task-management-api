...
-- Rollback the delete operation by inserting data back from backup tables
insert into cft_task_db.cft_task_db.task_history
select *
from deleted_tasks_task_history_backup;

insert into cft_task_db.cft_task_db.reportable_task
select *
from deleted_tasks_reportable_task_backup;

insert into cft_task_db.cft_task_db.task_assignments
select *
from deleted_tasks_task_assignments_backup;
...
-- Drop the backup tables that were created
drop table if exists cft_task_db.cft_task_db.deleted_tasks_reportable_task_backup;
drop table if exists cft_task_db.cft_task_db.deleted_tasks_task_history_backup;
drop table if exists cft_task_db.cft_task_db.deleted_tasks_task_assignments_backup;
