...
CREATE INDEX idx_rt_is_within_sla ON cft_task_db.reportable_task (is_within_sla);
CREATE INDEX idx_rt_state_termination_reason ON cft_task_db.reportable_task (state, termination_reason);
CREATE INDEX idx_rt_completed_date_time ON cft_task_db.reportable_task (completed_date_time);
CREATE INDEX idx_rt_completed_date ON cft_task_db.reportable_task (completed_date);
CREATE INDEX idx_rt_wait_time_days ON cft_task_db.reportable_task (wait_time_days);
CREATE INDEX idx_rt_wait_time ON cft_task_db.reportable_task (wait_time);
CREATE INDEX idx_rt_handling_time ON cft_task_db.reportable_task (handling_time);
CREATE INDEX idx_rt_processing_time ON cft_task_db.reportable_task (processing_time);
CREATE INDEX idx_rt_first_assigned_date ON cft_task_db.reportable_task (first_assigned_date);
CREATE INDEX idx_rt_first_assigned_date_time ON cft_task_db.reportable_task (first_assigned_date_time);
