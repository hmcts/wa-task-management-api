...
SELECT task_id,task_name,task_type,due_date_time,state,task_system,security_classification,title,description,notes,
       ...
       reconfigure_request_time,next_hearing_id,next_hearing_date,priority_date,last_reconfiguration_time
...
FETCH NEXT FROM task_history_cursor INTO
    ...
    l_reconfigure_request_time,l_next_hearing_id,l_next_hearing_date,l_priority_date,l_last_reconfiguration_time;
       ...
       if (l_update_action='AutoAssign') and (l_state='ASSIGNED') then
        ...
        insert into cft_task_db.reportable_task
            ...
            values
              ...
              l_last_reconfiguration_time, current_timestamp)
        ...
        SELECT update_action, final_state_label, wait_time_days, handling_time_days, processing_time_days,
               ...
               handling_time, processing_time, due_date_to_completed_diff_time INTO STRICT
               ...
               l_rt_handling_time, l_rt_processing_time, l_rt_due_date_to_completed_diff_time
...
EXCEPTION
    WHEN others THEN
        ...
        RAISE 'Reportable Task Upsert Error:%',SQLERRM;
