...
INSERT INTO cft_task_db.tasks (task_id, task_name, task_type, due_date_time, state, task_system, security_classification, title, description, notes, major_priority, minor_priority, assignee, auto_assigned, execution_type_code, work_type, role_category, has_warnings, assignment_expiry, case_id, case_type_id, case_category, case_name, jurisdiction, region, region_name, "location", location_name, business_context, termination_reason, created, additional_properties)
    ...
    '1652446087857201', 'WaCaseType', 'Protection', 'Bob Smith', 'WA', '1', NULL, '765324', 'Taylor House', NULL, NULL, '2022-05-13 13:48:18.972', '{"key1": "value1", "key2": "value2", "key3": "value3", "key4": "value4"}'::jsonb);
...
INSERT INTO cft_task_db.tasks (task_id, task_name, task_type, due_date_time, state, task_system, security_classification, title, description, notes, major_priority, minor_priority, assignee, auto_assigned, execution_type_code, work_type, role_category, has_warnings, assignment_expiry, case_id, case_type_id, case_category, case_name, jurisdiction, region, region_name, "location", location_name, business_context, termination_reason, created, additional_properties)
    ...
    '1652446087857202', 'WaCaseType', 'Protection', 'Bob Smith', 'WA', '1', NULL, '765324', 'Taylor House', NULL, NULL, '2022-05-13 13:48:18.972', '{"key1": "value1", "key2": "value2", "key3": "value3", "key4": "value4"}'::jsonb);
...
INSERT INTO cft_task_db.tasks (task_id, task_name, task_type, due_date_time, state, task_system, security_classification, title, description, notes, major_priority, minor_priority, assignee, auto_assigned, execution_type_code, work_type, role_category, has_warnings, assignment_expiry, case_id, case_type_id, case_category, case_name, jurisdiction, region, region_name, "location", location_name, business_context, termination_reason, created, additional_properties)
    ...
    '1652446087857203', 'WaCaseType', 'Protection', 'Bob Smith', 'WA', '1', NULL, '765324', 'Taylor House', NULL, NULL, '2022-05-13 13:48:18.972', '{"key1": "value1", "key2": "value2", "key3": "value3", "key4": "value4"}'::jsonb);
