...
values ('8d6cc5cf-c973-11eb-bdba-0242ac115019', 'tribunal-caseworker', true, true , true , false , false, false, null,
...
insert into cft_task_db.task_roles (task_role_id, role_name, "read", own, "execute", manage, cancel, refer, authorizations,
                                    assignment_priority, auto_assignable, role_category, task_id, created)
values ('8d6cc5cf-c973-11eb-bdba-0242ac115020', 'tribunal-caseworker', true, true , true, false, false , false, '{"DIVORCE", "IA"}',
