...
public class IntermediateDateTypeConfiguratorTest {
    ...
    public void should_calculate_both_dates_when_multiple_origin_refs_exist_for_two_date_types() {
        ...
        String nextHearingDurationValue = GIVEN_DATE.plusDays(3)
        ...
        ConfigurationDmnEvaluationResponse dueDateOriginEarliest = ConfigurationDmnEvaluationResponse.builder()
            ...
            .value(CamundaValue.stringValue("nextHearingDuration,nextHearingDate,priorityDate"))
            .build();
        ...
        ConfigurationDmnEvaluationResponse priorityDateOriginEarliest = ConfigurationDmnEvaluationResponse.builder()
            ...
            .value(CamundaValue.stringValue("nextHearingDuration,nextHearingDate,dueDate"))
            .build();
        ...
        List<ConfigurationDmnEvaluationResponse> evaluationResponses = readDueAndPriorityDateOriginFields(
            dueDateOriginEarliest, priorityDateOriginEarliest, calculatedDates, nextHearingDate, nextHearingDuration);
        ...
        Assertions.assertThat(configurationDmnEvaluationResponses)
            ...
            .isEqualTo(List.of(
                ...
                ConfigurationDmnEvaluationResponse.builder()
                    .name(CamundaValue.stringValue("nextHearingDuration"))
                    .value(CamundaValue.stringValue("2022-10-16T16:00"))
                    .build(),
                ConfigurationDmnEvaluationResponse.builder()
