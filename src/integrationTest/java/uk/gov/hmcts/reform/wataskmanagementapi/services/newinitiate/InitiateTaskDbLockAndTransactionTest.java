package uk.gov.hmcts.reform.wataskmanagementapi.services.newinitiate;
...
public class InitiateTaskDbLockAndTransactionTest extends SpringBootIntegrationBaseTest {
    ...
    private final InitiateTaskRequestNew initiateTaskRequest = new InitiateTaskRequestNew(INITIATION, taskAttributes);
