        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                resultHistory.then().assertThat()
                    ...
                    .body("task_history_list.get(2).due_date", notNullValue())
                    .body("task_history_list.get(2).last_updated_date", notNullValue())
                    .body("task_history_list.get(2).completed_date", nullValue())
                    .body("task_history_list.get(2).completed_date_time", nullValue())
                    .body("task_history_list.get(2).final_state_label", equalTo("USER_CANCELLED"))
                    .body("task_history_list.get(2).number_of_reassignments", equalTo(0))
